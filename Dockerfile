...
RUN rustup toolchain uninstall nightly-x86_64-unknown-linux-musl && rustup toolchain install nightly-x86_64-unknown-linux-musl && \
	...
	wget http://ftp.debian.org/debian/pool/main/g/grub2/grub-pc-bin_2.12-3_amd64.deb && \
	ar x grub-pc-bin_2.12-3_amd64.deb && \
	tar -xf data.tar.xz -C / && \
	rm -rf grub-pc-bin_2.12-3_amd64.deb data.tar.xz
